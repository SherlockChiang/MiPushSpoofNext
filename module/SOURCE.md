...
r27d. See `README.md` and `scripts/build.ps1` or `scripts/build.sh` in that
source archive for reproducible build instructions.

MiPush Spoof Next is licensed under GPL-3.0-or-later. See `LICENSE` and
`NOTICE.md` in this module.
